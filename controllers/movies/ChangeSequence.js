...
module.exports = async (req, res, next) => {
  ...
  try {
    ...
    // console.log(shortsOldDataMap, "....shortsOldDataMap");
    ...
    moviesResponse.shorts = sequenceArray.map((item) =>
      item === "Ads" ? item : new mongoose.Types.ObjectId(item)
    );
    console.log(moviesResponse.shorts, "....shorts"); 
    // .map(current=>{
    //     if(current==="Ads"){
    //         return "Ads"
    //     }
